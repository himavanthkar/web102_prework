...
const unfundedStr = `A total of ${unfundedCount} game${unfundedCount === 1 ? '' : 's'} ${unfundedCount === 1 ? 'remains' : 'remain'} unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const unfundedElem = document.createElement('p');
unfundedElem.textContent = unfundedStr;
descriptionContainer.appendChild(unfundedElem);
